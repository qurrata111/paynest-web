...
import { createRoleThunk } from "@/lib/redux/role/roleThunk";
...
const AddRolePage = () => {
    ...
    const { loading, roleAll, error } = useSelector((state: any) => state.role);
    ...
    const onSubmit = async (data: any) => {
        const res = await dispatch(createRoleThunk(data));
    ...
    return (
        <div className="pb-40">
            <div className="text-center text-xl font-semibold">Add Role</div>
            <form
                        ...
                        return (
                            <div key={index} className="border border-1 bg-yellow-50 rounded-lg p-2 mb-2">
                                ...
                                <div className="flex items-center">
                                    <Checkbox
                                        className={"bg-gray-50 border border-2 border-gray-200"}
                                        checked={
                                            (selectedMenus ?? []).some(
